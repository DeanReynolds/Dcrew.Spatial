...
namespace Dcrew.Spatial {
    ...
    public sealed class LooseQuadtree<T> : IEnumerable<T> where T : class, IBounds {
        ...
        internal sealed class CleanNodes : IGameComponent, IUpdateable {
            readonly LooseQuadtree<T> _tree;
            ...
            internal CleanNodes(LooseQuadtree<T> tree) => _tree = tree;
            ...
            public void Update(GameTime gameTime) {
                ...
                start:;
                    ...
                    if (n3.NW != null) {
                        ...
                        //bounds = Rectangle.Union(Rectangle.Union(Rectangle.Union(n3.NW.Bounds, n3.NE.Bounds), n3.SE.Bounds), n3.SW.Bounds);
                        //int l = Math.Min(n3.NW.Bounds.Width == 0 ? int.MaxValue : n3.NW.Bounds.Left, n3.SW.Bounds.Width == 0 ? int.MaxValue : n3.SW.Bounds.Left);
                        //int r = Math.Max(n3.NE.Bounds.Width == 0 ? int.MinValue : n3.NE.Bounds.Right, n3.SE.Bounds.Width == 0 ? int.MinValue : n3.SE.Bounds.Right);
                        //int t = Math.Min(n3.NW.Bounds.Height == 0 ? int.MaxValue : n3.NW.Bounds.Top, n3.NE.Bounds.Height == 0 ? int.MaxValue : n3.NE.Bounds.Top);
                        //int b = Math.Max(n3.SW.Bounds.Height == 0 ? int.MinValue : n3.SW.Bounds.Bottom, n3.SE.Bounds.Height == 0 ? int.MinValue : n3.SE.Bounds.Bottom);
        ...
        internal sealed class ExpandTree : IGameComponent, IUpdateable {
            ...
            internal ExpandTree(LooseQuadtree<T> tree) => _tree = tree;
